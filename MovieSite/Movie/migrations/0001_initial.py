    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie_name_en', models.CharField(max_length=200, null=True)),
                ('movie_name_ru', models.CharField(max_length=200, null=True)),
                ('movie_name_ch', models.CharField(max_length=200, null=True)),
                ('year', models.PositiveSmallIntegerField(blank=True, default=0, null=True)),
                ('type', models.PositiveSmallIntegerField(choices=[(144, '144p'), (360, '360p'), (480, '480p'), (720, '720p'), (1080, '1080p')])),
                ('movie_time', models.DurationField()),
                ('description', models.TextField()),
                ('description_en', models.TextField(null=True)),
                ('description_ru', models.TextField(null=True)),
                ('description_ch', models.TextField(null=True)),
                ('movie_trailer', models.FileField(blank=True, null=True, upload_to='', verbose_name='видео')),
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='movies', to='Movie.country')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('movie_moment', models.FileField(blank=True, null=True, upload_to='', verbose_name='видео')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='Movie.favorite')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='history', to='Movie.movie')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
